...
import chartIcon from '../../assets/Icon (1).jpg';
import messageIcon from '../../assets/message.jpg';
import zapIcon from '../../assets/Icon.jpg';
import iphone from '../../assets/iPhone.jpg';
import desktop from '../../assets/Screen mockup (REPLACE FILL).jpg';
    ...
    return (
        <div>
          ...
          <div className='image-container'>
            ...
            <img className='desktop'src={desktop} alt="desk"/>
            <img className='iphone'src={iphone} alt="phone"/>
          </div>
